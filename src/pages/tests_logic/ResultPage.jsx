...
import { fetchTestResults } from '../../api.js'; // Import the API function
...
const ResultPage = () => {
  ...
  useEffect(() => {
    const loadResults = async () => {
      try {
        const response = await fetchTestResults(testId);
                            ...
                            <div className="card-body">
                              ...
                              {!result.is_correct ? (
                                <>
                                  ...
                                  <div className="spinner-border text-primary book-suggestions-spinner" role="status">
                                    <span className="sr-only">Загрузка...</span>
                                  </div>
                                  <ul className="list-group mt-3 book-suggestions">
